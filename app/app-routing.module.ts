...
const routes: Routes = [
  ...
  {path:'rentalcar/:productid',component:RentalpageComponent,canDeactivate:[DeactivateGuardService]},
  {path:'payment/:bookingid',component:PaymentpageComponent,canDeactivate:[DeactivateGuardService]},
